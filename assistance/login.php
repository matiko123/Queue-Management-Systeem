...
<!--welcome starts-->
          <div class="card text-center">
            ...
            <div class="card-body background">
              ...
              <button  class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#login" id="assistanceLogin" style="display:none">Login</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Assistance Login</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form method="post" action="../control/assistancelogin.php">
          <div class="mb-3">
...
<script>
    if(window.location.href.indexOf('login.php?welcome') !== -1) {
       assistanceLogin.click();
      }
